          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-100 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 animate-fade-in delay-700">
                ...
                <p className="text-gray-700 mb-4 textalin">
                  With urbanization driving towards increasing waste generation, SACRED Foundation has developed innovative solutions in waste valorization. Our floral waste management projects, particularly in temples and religious places, convert organic waste into compost and biofuel. This approach supports a circular economy that minimizes environmental impact while creating economic opportunities for marginalized communities.
                </p>
              </div>
            ...
            <p className="text-gray-700 mb-6 animate-fade-in delay-1000 textalin">
            We sincerely appeal to one and all to get involved by participating in our advocacy campaigns, volunteering your time and skills, or donating to support our impactful initiatives. Your engagement will help us develop sustainable solutions for pressing environmental and social challenges. Together, we can drive meaningful change and contribute to a better and more sustainable future.
            </p>
