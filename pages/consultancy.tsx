        ...
        <section className="bg-white py-12 mb-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-gray-700 mb-6 animate-fade-in delay-200 textalin">
              SACRED Foundation offers consultancy services aimed at advancing sustainable development and creating measurable social impact. We collaborate with communities, governments, NGOs, and corporations to design bespoke strategies that address specific challenges. Our services focus on achieving carbon neutrality, enhancing social equity, and promoting sustainable growth.
            </p>
            <p className="text-lg text-gray-700 mb-6 animate-fade-in delay-200 textalin">
